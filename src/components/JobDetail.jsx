...
function JobDetail() {
  ...
  return (
    <>
      {jobDetail.length === 0 ? (
        <div className=" fixed   inset-0 flex items-center   flex-col px-3 justify-center z-50 bg-black bg-opacity-40">
          <div className=" w-full  lg:w-1/2 ">
            <div className="bg-white p-8 rounded-t-lg  shadow-lg   relative">
              <button
            ...
            <div className="bg-white p-8 mt-0 shadow-lg  overflow-y-auto sticky top-0">
